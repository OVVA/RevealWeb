    ...
    var Instagram = {
        ...
        getPhotos: function () {
            ...
            self.fetch().done( function ( results ) {
                ...
                } else if ( results.error && results.error.message ) {
            ...
            return $.ajax({
                ...
                success: function (response) {
                    ...
                    if (response.data && response.data.length) {
                        self.displayPhotos(response);
                    } else if (response.error && response.error.message) {
                        console.error("Spectragram.js - Error:", response.error.message);
                    } else {
                        console.error("Spectragram.js - Error: user does not have photos.");
                    }
                },
